# Software Developer Folio ⚡️ [![GitHub](https://img.shields.io/github/license/smooth55dev/developer-portfolio?color=blue)](https://github.com/smooth55dev/smooth55devFolio/blob/master/LICENSE) [![GitHub stars](https://img.shields.io/github/stars/smooth55dev/smooth55devFolio)](https://github.com/smooth55dev/smooth55devFolio/stargazers)  [![All Contributors](https://img.shields.io/badge/all_contributors-4-orange.svg?style=flat-square)](#contributors)
...
If you'd like to **contribute** and make this much better for other users, have a look at [Issues](https://github.com/smooth55dev/smooth55devFolio/issues).

Created something awesome for your fork of the portfolio and want to share it? Feel free to open a [pull request](https://github.com/smooth55dev/smooth55devFolio/pulls).
...
To view a live example, **[click here](https://smooth55devFolio.js.org/)**.
...
```
1) BUILD IMAGE : docker build -t smooth55devFolio:latest .
2) RUN IMAGE: docker run -t -p 3000:3000 smooth55devFolio:latest
```


## How To Use 

From your command line, clone and run smooth55devFolio:

```bash
# Clone this repository
git clone https://github.com/smooth55dev/smooth55devFolio.git
...
If the above solution still doesn't work, visit the [wiki page](https://github.com/smooth55dev/smooth55devFolio/wiki/Github-Setup-For-Open-Source-Projects).
...
- Navigate to `package.json` and enter your domain name instead of `https://smooth55devFolio.js.org/` in `homepage` variable. For example, if you want your site to be `https://<your-username>.github.io/smooth55devFolio`, add the same to the homepage section of `package.json`.
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/smooth55dev/smooth55devFolio)
...
## For the Future
If you can help us with these. Please don't hesitate to open a [pull request](https://github.com/smooth55dev/smooth55devFolio/pulls).
